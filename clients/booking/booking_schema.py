...
class Dates(BaseModel):
    check_in: str = Field(alias="checkin", default_factory=fake.date)
    check_out: str = Field(alias="checkout", default_factory=fake.date)
...
class CreateBookingRequestSchema(BaseModel):
    ...
    deposit_paid: bool = Field(alias="depositpaid", default_factory=True)
    booking_dates: Dates = Field(alias="bookingdates")
    additional_needs: str = Field(alias="additionalneeds", default_factory="Breakfast")
...
class UpdateBoookingRequestSchema(BaseModel):
    ...
    total_price: int | None = Field(alias="totalprice")
    deposit_paid: bool | None = Field(alias="depositpaid")
    booking_dates: Dates | None = Field(alias="bookingdates")
    additional_needs: str | None = Field(alias="additionalneeds")
